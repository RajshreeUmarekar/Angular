...
import { InjectionToken, Pipe, EventEmitter, forwardRef, Component, Inject, Input, ViewChild, Output, NgModule } from '@angular/core';
...
const MatSelectCountryLangToken = new InjectionToken('MatSelectCountryLangToken');
...
JoinStringsPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.1", ngImport: i0, type: JoinStringsPipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe });
JoinStringsPipe.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "15.0.1", ngImport: i0, type: JoinStringsPipe, name: "joinStrings" });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.1", ngImport: i0, type: JoinStringsPipe, decorators: [{
            type: Pipe,
...
class MatSelectCountryComponent {
    ...
    ngOnChanges(changes) {
        ...
        if (((_c = changes.language) === null || _c === void 0 ? void 0 : _c.currentValue) &&
            ...
            this._loadCountriesFromDb(lastValue === null || lastValue === void 0 ? void 0 : lastValue.alpha2Code);
        }
    }
    onBlur() {
        if (this.nullable &&
    ...
    _importLang() {
        ...
        switch (lang) {
            case "br":
                return Promise.resolve().then(function () { return br; })
                    .then((result) => result.COUNTRIES_DB_BR)
                    .then((y) => y);
            case "by":
                return Promise.resolve().then(function () { return by; })
                    .then((result) => result.COUNTRIES_DB_BY)
                    .then((y) => y);
            case "de":
                return Promise.resolve().then(function () { return de; })
                    .then((result) => result.COUNTRIES_DB_DE)
                    .then((y) => y);
            case "es":
                return Promise.resolve().then(function () { return es; })
                    .then((result) => result.COUNTRIES_DB_ES)
                    .then((y) => y);
            case "fr":
                return Promise.resolve().then(function () { return fr; })
                    .then((result) => result.COUNTRIES_DB_FR)
                    .then((y) => y);
            case "hr":
                return Promise.resolve().then(function () { return hr; })
                    .then((result) => result.COUNTRIES_DB_HR)
                    .then((y) => y);
            case "hu":
                return Promise.resolve().then(function () { return hu; })
                    .then((result) => result.COUNTRIES_DB_HU)
                    .then((y) => y);
            case "it":
                return Promise.resolve().then(function () { return it; })
                    .then((result) => result.COUNTRIES_DB_IT)
                    .then((y) => y);
            case "nl":
                return Promise.resolve().then(function () { return nl; })
                    .then((result) => result.COUNTRIES_DB_NL)
                    .then((y) => y);
            case "pt":
                return Promise.resolve().then(function () { return pt; })
                    .then((result) => result.COUNTRIES_DB_PT)
                    .then((y) => y);
            case "ru":
                return Promise.resolve().then(function () { return ru; })
            ...
            case "ua":
                return Promise.resolve().then(function () { return ua; })
                    ...
                    .then((y) => y);
            case "gl":
                return Promise.resolve().then(function () { return gl; })
                    .then((result) => result.COUNTRIES_DB_GL)
                    .then((y) => y);
            case "eu":
                return Promise.resolve().then(function () { return eu; })
                    .then((result) => result.COUNTRIES_DB_EU)
                    .then((y) => y);
            case "ca":
                return Promise.resolve().then(function () { return ca; })
                    .then((result) => result.COUNTRIES_DB_CA)
                    .then((y) => y);
            default:
                return Promise.resolve().then(function () { return en; })
...
var br = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_BR: COUNTRIES_DB_BR
});

const COUNTRIES_DB_BY = [
    {
        name: 'Афганістан',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var by = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_BY: COUNTRIES_DB_BY
});

const COUNTRIES_DB_DE = [
    {
        name: 'Afghanistan',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var de = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_DE: COUNTRIES_DB_DE
});
...
var es = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_ES: COUNTRIES_DB_ES
});

const COUNTRIES_DB_FR = [
    {
        name: 'Afghanistan',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var fr = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_FR: COUNTRIES_DB_FR
});

const COUNTRIES_DB_HR = [
    {
        name: 'Afganistan',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var hr = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_HR: COUNTRIES_DB_HR
});

const COUNTRIES_DB_HU = [
    {
        name: 'Afganisztán',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var hu = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_HU: COUNTRIES_DB_HU
});

const COUNTRIES_DB_IT = [
    {
        name: 'Afghanistan',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var it = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_IT: COUNTRIES_DB_IT
});

const COUNTRIES_DB_GL = [
    {
        "name": "Afganistán",
        "alpha2Code": "AF",
        "alpha3Code": "AFG",
...
var gl = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_GL: COUNTRIES_DB_GL
});

const COUNTRIES_DB_CA = [
    {
        "name": "l'Afganistan",
        "alpha2Code": "AF",
        "alpha3Code": "AFG",
...
var ca = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_CA: COUNTRIES_DB_CA
});

const COUNTRIES_DB_EU = [
    {
        "name": "Afganistan",
        "alpha2Code": "AF",
        "alpha3Code": "AFG",
...
var eu = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_EU: COUNTRIES_DB_EU
});

const COUNTRIES_DB_NL = [
    {
        name: 'Afghanistan',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var nl = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_NL: COUNTRIES_DB_NL
});

const COUNTRIES_DB_PT = [
    {
        name: 'Afeganistão',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var pt = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_PT: COUNTRIES_DB_PT
});

const COUNTRIES_DB_RU = [
    {
        name: 'Афганистан',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var ru = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_RU: COUNTRIES_DB_RU
});

const COUNTRIES_DB_UA = [
    {
        name: 'Афганістан',
        alpha2Code: 'AF',
        alpha3Code: 'AFG',
...
var ua = /*#__PURE__*/Object.freeze({
    __proto__: null,
    COUNTRIES_DB_UA: COUNTRIES_DB_UA
});
...
MatSelectCountryModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.1", ngImport: i0, type: MatSelectCountryModule, deps: [{ token: i1$1.MatIconRegistry }, { token: i2$1.DomSanitizer }], target: i0.ɵɵFactoryTarget.NgModule });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.1", ngImport: i0, type: MatSelectCountryModule, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.MatIconRegistry }, { type: i2$1.DomSanitizer }]; } });
...
export { COUNTRIES_DB, COUNTRIES_DB_BR, COUNTRIES_DB_BY, COUNTRIES_DB_CA, COUNTRIES_DB_DE, COUNTRIES_DB_ES, COUNTRIES_DB_EU, COUNTRIES_DB_FR, COUNTRIES_DB_GL, COUNTRIES_DB_HR, COUNTRIES_DB_HU, COUNTRIES_DB_IT, COUNTRIES_DB_NL, COUNTRIES_DB_PT, COUNTRIES_DB_RU, COUNTRIES_DB_UA, MatSelectCountryComponent, MatSelectCountryLangToken, MatSelectCountryModule };
//# sourceMappingURL=angular-material-extensions-select-country.mjs.map
//# sourceMappingURL=angular-material-extensions-select-country.mjs.map
